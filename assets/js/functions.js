  ...
  (function () {
    ...
    if (pricingSliders.length > 0) {
      var _loop = function _loop(i) {
        var pricingSlider = pricingSliders[i]; // Build the input object
        ...
        pricingInput.thumbSize = parseInt(window.getComputedStyle(pricingInput.currentValEl).getPropertyValue("--thumb-size"), 10); // Build the output array
        ...
        for (var _i = 0; _i < pricingOutputEls.length; _i++) {
          ...
          pricingOutputObj.currency = pricingOutputEl.querySelector(".pricing-item-price-currency");
          pricingOutputObj.amount = pricingOutputEl.querySelector(".pricing-item-price-amount");
          pricingOutputObj.after = pricingOutputEl.querySelector(".pricing-item-price-after");
    ...
    function handlePricingSlider(input, output) {
      ...
      if (input.currentValEl) input.currentValEl.innerHTML = input.data[input.el.value]; // update prices

      for (var i = 0; i < output.length; i++) {
        var outputObj = output[i];
